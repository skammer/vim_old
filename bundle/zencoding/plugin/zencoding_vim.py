...
def get_currenr_syntax():
	return vim.eval('b:current_syntax')

def get_profile_name():
	current_syntax = get_currenr_syntax()
	if current_syntax == 'html':
		return 'html'
	elif current_syntax == 'xsl':
		return 'xml'
	else:
		return 'xhtml'
